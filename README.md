...
[GitHub Releases](https://github.com/HanayumiR/Auralis/releases) から Windows x64，macOS Apple Silicon（arm64），macOS Intel（x64）向けの最新版をダウンロードできます。
...
Download the latest Windows x64, macOS Apple Silicon (arm64), or macOS Intel (x64) build from [GitHub Releases](https://github.com/HanayumiR/Auralis/releases).
